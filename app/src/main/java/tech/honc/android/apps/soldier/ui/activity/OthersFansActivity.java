...
import tech.honc.android.apps.soldier.ui.fragment.OtherFansFragment;

/**
 * Created by MrJiang on 2016/5/16.
 * 别人的关注
 */
public class OthersFansActivity extends SimpleSinglePaneActivity {
  @Override protected Fragment onCreatePane() {
    Bundle bundle = new Bundle();
    bundle.putInt("id", getIntent().getIntExtra("id", 0));
    OtherFansFragment fragment = OtherFansFragment.newInstance();
