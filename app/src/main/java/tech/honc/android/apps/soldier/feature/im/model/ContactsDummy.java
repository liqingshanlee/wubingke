...
public class ContactsDummy {
  ...
  public static ContactsDummy newContacts() {
    return new ContactsDummy(R.drawable.support_im_contacts_new_contact,
       R.string.support_im_contacts_new_contact, NEW_CONTACTS);
  }

  public static ContactsDummy group() {
    return new ContactsDummy(R.drawable.support_im_contacts_group,
        R.string.support_im_contacts_group, GROUP);
  }
}
