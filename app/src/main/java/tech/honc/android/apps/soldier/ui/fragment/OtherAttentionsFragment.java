 ...
 * 别人的关注
 */
public class OtherAttentionsFragment extends BaseKeysFragment<User> {
  ...
  public static OtherAttentionsFragment newInstance() {
    return new OtherAttentionsFragment();
  }

  @Override public Call<ArrayList<User>> paginate(User sinceItem, User maxItem, int perPage) {
    return mAttentionService.othersAttentions(getArguments().getInt("id"));
  }
