...
public class PhotoCollectionView extends RecyclerView {
  ...
  private void initialize() {
    ...
    int avatarSize =
        StarterKitApp.appResources().getDimensionPixelSize(R.dimen.simple_dynanic_width);
    int innerMargin = StarterKitApp.appResources().getDimensionPixelSize(R.dimen.view_margin_16);
