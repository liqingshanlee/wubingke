...
public class PreviewImageActivity extends BaseActivity {
  ...
  private void initImageView() {
    ...
    YWFileManager fileManager = LoginHelper.getInstance().getYWIMKit().getIMCore().getFileManager();
  ...
  private void showImage(final String filePath) {
    ...
    YWConversation conversation = mIMKit.getConversationService()
        .getConversationByConversationId(mMessage.getConversationId());
  ...
  private void sendPrivateImageMsgReadStatus(YWConversation conversation) {
    ...
    try {
      object.put("customizeMessageType", ChattingOperation.CustomMessageType.READ_STATUS);
