 ...
 * on 2016/4/21.
 */
public class ArticleViewHolder extends EasyViewHolder<Article> {
  ...
  public ArticleViewHolder(Context context, ViewGroup parent) {
  ...
  @Override public void bindTo(int position, Article value) {
    ...
    mTypeTime.setText(" " + DateFormat.getRelativeTime(value.publishedAt));
  }
}
